---
description: "Web GUI Host 侧的包映射：HTTP 与 SPA 服务器、工作区目录选择实现、open-in-app 启动路由、插件清单投影和 skill 库 Remote。"
kind: "package-group"
---
...
| [`skill-library/`](skill-library/README.zh.md) | 列出并改写用户与项目 skill 文件 | Remote `skillLibrary` |
