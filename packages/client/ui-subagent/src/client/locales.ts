...
export const vi: Record<SubagentKey, string>  = {
  'diagnostic.corrupt': 'corrupted session record',
  'diagnostic.unsupported': 'phiên bản bản ghi subagent không hỗ trợ',
  'diagnostic.unavailable': 'session record temporarily unavailable',
  'duration.seconds': '{seconds}s',
  'duration.minutes': '{minutes}m {seconds}s',
  'duration.hours': '{hours}h {minutes}m {seconds}s',
  ...
  'readonly.oneShot.body': 'Tác vụ một lần không nhận tin tiếp; hãy xem toàn bộ nhật ký thực thi tại đây.',
  'readonly.body': 'Phiên cha đang ngoại tuyến; hãy mở lại để tiếp tục gửi tin.',
}
