...
export const vi = {
  ...
  'stats.dialog.usageTitle': 'Lượng token',
  ...
  'chat.turnNavigation.jump': 'Nhảy tới lượt {turn}',
  'chat.turnNavigation.jumpLoad': 'Tải và nhảy tới lượt {turn}',
  'chat.turnNavigation.turn': 'Lượt {turn}',
  'settings.transcript.title': 'Hiển thị hội thoại',
  'settings.transcript.description': 'Điều khiển nội dung quá trình trong các lượt đã xong',
  ...
  'message.extraBlock': 'Khối nội dung thêm',
  'message.systemPrompt': 'System prompt',
  'message.systemPromptUpdate': 'Cập nhật system prompt',
  'message.contextInjection': 'Bơm ngữ cảnh',
  'message.contextRecall': 'Gợi nhớ phiên',
  'message.referenceSummary': 'Phiên tham chiếu · {labels}',
  'message.referenceSeparator': ', ',
  ...
  'message.context.catalog.more': '… {count} nữa',
  'message.context.snapshot.supersedes': 'Thay các snapshot trước',
  'message.context.relay.from': 'Từ phiên {session}',
  'message.context.recall.counts': '{retained} giữ · {omitted} bỏ',
  ...
  'message.branch': 'Nhánh sang hội thoại mới',
  'message.branchUnavailable': 'Chỉ dùng được trên tin nhắn cuối của lượt đã hoàn tất',
  ...
  'message.maxTokens': 'Đã tới giới hạn token đầu ra',
  'message.maxTokens.hint': 'Câu trả lời bị cắt; phần đã sinh vẫn giữ trong hội thoại. Gửi "continue" để mô hình tiếp tục.',
  'message.ranFor': 'Chạy trong {duration}',
  'message.tokensPerSecond': '{tps} tok/s',
  'message.turnUsage.title': 'Lượng dùng lượt',
  ...
  'message.turnUsage.count': '{count} tok',
  'message.turnTime.title': 'Thời gian và tốc độ lượt',
  'message.turnTime.duration': 'Tổng thời gian chạy',
  'message.turnTime.speed': 'Token mỗi giây (TPS)',
  'message.turnTime.ttft': 'Thời gian tới token đầu (TTFT)',
  'duration.seconds': '{seconds}s',
  'duration.minutes': '{minutes}m {seconds}s',
