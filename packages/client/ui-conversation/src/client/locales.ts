...
export const zh = {
  ...
  'settings.enter.description': '智能体运行时发送手势和发送按钮的行为；Cmd/Ctrl+Enter 使用另一行为',
  'settings.enter.queue': '排队发送',
  'settings.enter.steer': '插话发送',
  'settings.sendKey.title': '发送快捷键',
  'settings.sendKey.description': 'Enter 换行，Ctrl/Alt+Enter 发送；可改为 Enter 直接发送',
  'settings.sendKey.newline': 'Enter 换行',
  'settings.sendKey.send': 'Enter 发送',
...
export const en = {
  ...
  'settings.enter.description': 'What a send gesture and the Send button do while the agent is running; Cmd/Ctrl+Enter uses the other behavior',
  'settings.enter.queue': 'Queue',
  'settings.enter.steer': 'Steer',
  'settings.sendKey.title': 'Send shortcut',
  'settings.sendKey.description': 'Enter inserts a new line; Ctrl/Alt+Enter sends. Reverse this so Enter sends.',
  'settings.sendKey.newline': 'Enter inserts a new line',
  'settings.sendKey.send': 'Enter sends',
...
export const vi = {
  ...
  'hint.goal.active': 'mục tiêu đang chạy — edit / pause / resume / clear',
  ...
  'placeholder.parentOffline': 'Phiên cha đang ngoại tuyến; không gửi được nhưng vẫn có thể dừng chạy',
  'placeholder.hero': 'Mô tả điều bạn muốn xây, / lệnh, @ tệp hoặc phiên',
  'placeholder.workspace': 'Chọn workspace để bắt đầu',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter ngắt lời mọi tin nhắn đang xếp hàng',
  'input.commands': 'Lệnh',
  'input.stop': 'Dừng tạo',
  'input.send': 'Gửi tin nhắn',
  'input.send.queue': 'Xếp hàng gửi',
  'input.send.steer': 'Ngắt lời gửi',
  'input.accessMode': 'Chế độ quyền, hiện tại: {name}',
  ...
  'image.openOriginal': 'Xem bản gốc',
  'image.openOriginalLabel': '{label}, nhấp để xem bản gốc',
  ...
  'image.tooMany': 'Một tin nhắn có thể gồm tối đa {count} ảnh',
  'image.fileTooLarge': 'Mỗi ảnh phải nhỏ hơn {size}',
  'image.totalTooLarge': 'Tổng dung lượng ảnh vượt {size}; hãy bớt ảnh rồi thử lại',
  'image.tooManyPixels': 'Độ phân giải ảnh quá cao; hãy nén rồi thử lại',
  'image.dimensionTooLarge': 'Cạnh ảnh tối đa {size}px; hãy thu nhỏ rồi thử lại',
  'image.modelUnsupported': 'Mô hình hiện tại không hỗ trợ ảnh; hãy chuyển sang mô hình hỗ trợ',
  'image.sendFailed': 'Gửi ảnh thất bại ({reason}); hãy thêm lại rồi thử',
  ...
  'file.stillUploading': 'Tệp vẫn đang tải lên; gửi sau khi hoàn tất',
  'file.sessionUnavailable': 'Phiên không khả dụng; không tải tệp được',
  'file.notStaged': 'Tệp chưa tải xong; hãy thêm lại rồi thử',
  'file.label': 'Tệp',
  ...
  'settings.enter.description': 'Cử chỉ gửi và nút Gửi làm gì khi tác nhân đang chạy; Cmd/Ctrl+Enter dùng hành vi còn lại',
  'settings.enter.queue': 'Xếp hàng',
  'settings.enter.steer': 'Ngắt lời',
  'settings.sendKey.title': 'Phím tắt gửi tin',
  'settings.sendKey.description': 'Enter xuống dòng; Ctrl/Alt+Enter gửi. Có thể đảo lại để Enter gửi tin.',
  'settings.sendKey.newline': 'Enter xuống dòng',
  'settings.sendKey.send': 'Enter gửi tin',
  'access.preset.readOnly': 'Chỉ xem',
  'access.preset.workspaceWrite': 'Ghi trong workspace',
  'access.preset.fullAccess': 'Toàn quyền',
  'access.confirm.title': 'Bật toàn quyền?',
  'access.confirm.description': 'Toàn quyền giảm bước xác nhận và cho phép tác nhân thực hiện nhiều thao tác trực tiếp hơn, gồm thao tác nhạy cảm, thay đổi tệp hoặc lệnh bên ngoài. Chỉ dùng khi bạn tin tác vụ hiện tại.',
  'access.confirm.acknowledge': 'Tôi hiểu rủi ro và muốn tiếp tục',
  'access.confirm.cancel': 'Hủy',
  'access.confirm.enable': 'Bật toàn quyền',
  'hero.headline': 'Khám phá những điều chưa biết',
  'hero.preview': 'Xem trước',
  'hero.chooseWorkspace': 'Chọn workspace',
  'session.hierarchy': 'Phân cấp phiên',
  ...
  'ask.cancelledDetail': 'Bộ câu hỏi này bị hủy trước khi gửi câu trả lời.',
  'ask.interrupted': 'bị ngắt',
  'ask.interruptedDetail': 'Bộ câu hỏi này bị ngắt trước khi gửi câu trả lời.',
  ...
  'queue.steer': 'Ngắt lời tin nhắn xếp hàng',
  'queue.steer.unavailable': 'Chỉ ngắt lời được khi tác nhân đang chạy',
  'queue.editFailed': 'Sửa thất bại: tin nhắn có thể đã bắt đầu gửi.',
  'queue.removeFailed': 'Xóa thất bại: tin nhắn có thể đã bắt đầu gửi.',
  'queue.steerFailed': 'Ngắt lời thất bại. Hãy thử lại.',
