...
export const vi = {
  nav: 'Mô hình',
  title: 'Mô hình',
  intro: 'Nhập khóa API để dùng mô hình từ các nhà cung cấp sau.',
  edit: 'Sửa',
  editProvider: 'Sửa {provider}',
  remove: 'Xóa',
  removeProvider: 'Xóa {provider}',
  deleteTitle: 'Xóa {provider}?',
  deleteDescription: 'Xóa {provider} sẽ gỡ cấu hình. Khóa xác thực dùng chung được quản lý nơi khác và sẽ được giữ.',
  deleteDescriptionWithCredential: 'Xóa {provider} sẽ gỡ cấu hình và khóa API đã lưu.',
  ...
  readOnly: 'Tài liệu cài đặt ở bản triển khai này chỉ đọc.',
  loadFailed: 'Không tải được danh mục nhà cung cấp',
  conflict: 'Ai đó đã đổi cài đặt khi thẻ này đang mở. Đóng rồi mở lại để sửa giá trị hiện tại.',
  retry: 'Thử lại',
  keyInput: 'Khóa API',
  keyPlaceholder: 'Nhập khóa API',
  keyPlaceholderNative: 'Nhập khóa API, hoặc để trống để dùng xác thực môi trường',
  keyStored: 'Đã cấu hình — nhập giá trị mới để thay',
  keyEnvLocked: 'Do môi trường khởi chạy cung cấp (chỉ đọc)',
  customized: 'Cài đặt tùy chỉnh',
  baseUrl: 'URL cơ sở',
  baseUrlDefault: 'Mặc định nhà cung cấp',
  models: 'Mô hình',
  modelsInherited: 'Dùng mặc định của adapter',
  ...
  contextWindowPlaceholder: 'Dùng mặc định nhà cung cấp',
  maxTokens: 'Token đầu ra tối đa',
  maxTokensPlaceholder: 'Dùng mặc định nhà cung cấp',
  modelAdvanced: 'Năng lực',
  addModel: 'Thêm mô hình',
  removeModel: 'Xóa mô hình',
  modelsEmpty: 'Bộ chọn sẽ không hiện mô hình nào. ID chưa liệt kê vẫn gửi trực tiếp được.',
  keyBlank: 'Nhập khóa API, hoặc để trống để giữ khóa đã lưu.',
  keyBlankNew: 'Nhập khóa API, hoặc để trống nếu nhà cung cấp xác thực cách khác.',
  keyIllegalCharacters: 'Khóa API không đúng định dạng. Hãy kiểm tra lại.',
  modelIdRequired: 'Cần ID mô hình.',
  ...
  advancedHint: 'Các trường khác nằm trong settings.yaml; hãy sửa trực tiếp mục đó.',
  modelCapacityInvalid: 'Năng lực phải là số, có thể thêm hậu tố K hoặc M.',
  ...
  fetchNeedsBaseUrl: 'Nhập URL cơ sở trước, rồi lấy danh sách.',
  fetchEmpty: 'Nhà cung cấp không liệt kê mô hình. Hãy thêm thủ công.',
  fetchTitle: 'Chọn mô hình để thêm',
  fetchDescription: 'Đây là các mô hình nhà cung cấp này có. Chọn những mô hình cần thêm.',
  ...
  customRouteHint: 'Định danh chữ thường, bắt đầu bằng chữ cái, dùng để gọi nhà cung cấp và đặt tên khóa.',
  customRouteInvalid: 'Bắt đầu bằng chữ thường; sau đó là chữ thường, chữ số và dấu gạch ngang.',
  customRouteTaken: 'Một nhà cung cấp đã dùng ID này.',
  customDisplayName: 'Tên hiển thị',
  customApi: 'Giao thức API',
  customApiUnset: 'Chưa chọn',
  customNeedsBaseUrl: 'Nhà cung cấp tùy chỉnh cần URL cơ sở.',
  customBaseUrlInvalid: 'Nhập URL HTTP hoặc HTTPS hợp lệ.',
  customNeedsModels: 'Nhà cung cấp tùy chỉnh cần ít nhất một mô hình.',
  customBaseUrlPlaceholder: 'https://gateway.example/v1',
  settingsPathUnresolvable: 'không phân giải được đường dẫn cài đặt',
  create: 'Tạo nhà cung cấp',
  creating: 'Đang tạo\u2026',
  welcomeTitle: 'Thông báo thử nghiệm nội bộ',
  welcomeBody: 'Harness 0.1 vẫn đang thử nghiệm cho nhà phát triển. Nhiều phần còn cần cải thiện, và chúng tôi rất muốn nhận phản hồi. Các plugin cốt lõi cùng API nền sẽ tiếp tục thay đổi nhanh trong những tháng tới.\n\nChúng tôi mong cùng nhà phát triển khắp nơi khám phá giới hạn trí tuệ trên hạ tầng mã nguồn mở, mở, tái sử dụng và kết hợp được. Mọi nhà phát triển Harness đều được chào đón vào hệ sinh thái plugin.',
  welcomeContinue: 'Tiếp tục',
  welcomeError: 'Không lưu được xác nhận. Hãy thử lại.',
  onboardingTitle: 'Thêm khóa API để bắt đầu',
  onboardingDescription: 'Cấu hình một nhà cung cấp mô hình để bắt đầu.',
