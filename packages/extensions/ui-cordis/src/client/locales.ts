...
export const vi = {
  ...
  'run.superseded': 'Thẻ lần chạy mới hơn nằm bên dưới',
  ...
  'panel.readFailed': 'Không đọc được kho plugin: {message}',
  ...
  'action.rollback': 'Roll back',
  'action.inspect': 'Xem',
  'render.failedAbdicated': 'Kết xuất thất bại ở {slot}; giao diện mặc định đã được khôi phục:',
  'render.failedHeld': 'Kết xuất thất bại ở {slot}:',
