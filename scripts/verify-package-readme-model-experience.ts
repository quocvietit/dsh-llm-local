...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-skills': { kind: 'none', reason: 'Browser-side Settings page for local skill files; registers nothing model-facing.' },
  ...
  'packages/host/skill-library': { kind: 'none', reason: 'Host Remote for local skill files; registers nothing model-facing. The filesystem provider and dsh-tool-skill own catalog projection.' },
