...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SkillLibraryEntry: 'skills.md',
  SkillLibraryGetRequest: 'skills.md',
  SkillLibraryListRequest: 'skills.md',
  SkillLibraryListValue: 'skills.md',
  SkillLibraryRecord: 'skills.md',
  SkillLibraryRemoveRequest: 'skills.md',
  SkillLibraryWriteRequest: 'skills.md',
