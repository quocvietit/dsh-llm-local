...
| `ctx.skillLibrary` | `core` | [`host-skill-library`](../packages/host/skill-library) | - | - | - | Lists disk skills and mutates user and project SKILL.md files for the Web Settings library page. |
